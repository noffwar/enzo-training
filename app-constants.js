...
export const trainingPlanRoutines = {
  "1": { id:"1", name:"Torso A", fullName:"DIA 1: Torso A", description:"Vector primario: empuje y tension mecanica", exercises:[
    ...
    { name:"Hombro vuelo lateral", sets:[mkSet("15","9,0","2",90,"1,5 min"),mkSet("12","9,0","1",90,"1,5 min"),mkSet("10","9,0","0 (Fallo),mkSet("10","9,0","0 (Fallo)] },
    { name:"Encogimientos de Trapecio", sets:[mkSet("15","21,0","2",90,"1,5 min"),mkSet("12","25,0","1",90,"1,5 min"),mkSet("12","25,0","0 (Fallo),mkSet("12","25,0","0 (Fallo)] },
    { name:"Cruces en polea alta", sets:[mkSet("15","15,0","1",90,"1,5 min"),mkSet("12","20,0","1",90,"1,5 min"),mkSet("12","20,0","0 (Fallo),mkSet("12","20,0","0 (Fallo)] },
    { name:"Cruces invertidos en polea", sets:[mkSet("15","5,0","1",90,"1,5 min"),mkSet("12","7,5","1",90,"1,5 min"),mkSet("12","7,5","0 (Fallo),mkSet("12","7,5","0 (Fallo)] },
  ...
  "2": { id:"2", name:"Pierna A + Brazos A", fullName:"DIA 2: Pierna A y Brazos A", description:"Vector primario: cuadriceps, gemelos, brazos y core", exercises:[
    ...
    { name:"Maquina cuadriceps (Extensiones Bilaterales)", sets:[mkSet("15","35,0","2",90,"1,5 min"),mkSet("12","40,0","1",90,"1,5 min"),mkSet("10","45,0","0 (Fallo),mkSet("10","45,0","0 (Fallo)] },
    { name:"Curl femoral tumbado", sets:[mkSet("15","25,0","2",90,"1,5 min"),mkSet("12","30,0","1",90,"1,5 min"),mkSet("10","35,0","0 (Fallo),mkSet("10","35,0","0 (Fallo)] },
    { name:"Aductores maquina", sets:[mkSet("15","65,0","1",90,"1,5 min"),mkSet("12","70,0","0 (Fallo),mkSet("12","70,0","0 (Fallo),mkSet("12","70,0","0 (Fallo)] },
    { name:"Elevacion de Gemelos de pie", sets:[mkSet("Metodo 7-7-7","40,0","2",90,"1,5 min"),mkSet("Metodo 7-7-7","60,0","1",90,"1,5 min"),mkSet("Metodo 7-7-7","70,0","0 (Fallo),mkSet("Metodo 7-7-7","70,0","0 (Fallo)] },
    { name:"Soleos banco", sets:[mkSet("20","20,0","2",90,"1,5 min"),mkSet("18","22,5","1",90,"1,5 min"),mkSet("15","25,0","1",90,"1,5 min"),mkSet("15","25,0","0 (Fallo),mkSet("15","25,0","0 (Fallo)] },
    { name:"Curl Biceps Martillo mancuernas", sets:[mkSet("12","10,0","1",90,"1,5 min"),mkSet("10","12,5","1",90,"1,5 min"),mkSet("10","12,5","0 (Fallo),mkSet("10","12,5","0 (Fallo)] },
    { name:"Triceps polea con barra", sets:[mkSet("15","35,0","2",90,"1,5 min"),mkSet("12","40,0","1",90,"1,5 min"),mkSet("10","45,0","0 (Fallo),mkSet("10","45,0","0 (Fallo)] },
  ...
  "3": { id:"3", name:"Accesorios + Core", fullName:"DIA 3: Accesorios y Core", description:"Vector primario: hombro lateral, brazos y estabilidad", exercises:[
    ...
    { name:"Encogimientos de Trapecio", sets:[mkSet("15","21,0","2",90,"1,5 min"),mkSet("12","25,0","1",90,"1,5 min"),mkSet("12","25,0","0 (Fallo),mkSet("12","25,0","0 (Fallo)] },
    { name:"Curl Biceps Martillo mancuernas", sets:[mkSet("12","10,0","1",90,"1,5 min"),mkSet("10","12,5","1",90,"1,5 min"),mkSet("10","12,5","0 (Fallo),mkSet("10","12,5","0 (Fallo)] },
    { name:"Mancuernas biceps supino", sets:[mkSet("15","10,0","2",90,"1,5 min"),mkSet("12","12,5","1",90,"1,5 min"),mkSet("10","12,5","0 (Fallo),mkSet("10","12,5","0 (Fallo)] },
    { name:"Triceps polea con barra", sets:[mkSet("15","35,0","2",90,"1,5 min"),mkSet("12","40,0","1",90,"1,5 min"),mkSet("10","45,0","0 (Fallo),mkSet("10","45,0","0 (Fallo)] },
    { name:"Triceps polea soga", sets:[mkSet("15","25,0","2",90,"1,5 min"),mkSet("12","30,0","1",90,"1,5 min"),mkSet("10","35,0","0 (Fallo),mkSet("10","35,0","0 (Fallo)] },
  ...
  "4": { id:"4", name:"Torso B", fullName:"DIA 4: Torso B", description:"Vector primario: traccion y postura", exercises:[
    ...
    { name:"Mariposa (Pectoral)", sets:[mkSet("15","40,0","2",90,"1,5 min"),mkSet("12","50,0","1",90,"1,5 min"),mkSet("10","55,0","0 (Fallo),mkSet("10","55,0","0 (Fallo)] },
    { name:"Facepull en Polea Alta", sets:[mkSet("15","15,0","2",90,"1,5 min"),mkSet("12","20,0","1",90,"1,5 min"),mkSet("12","20,0","0 (Fallo),mkSet("12","20,0","0 (Fallo)] },
    { name:"Hombro vuelo lateral en polea baja", sets:[mkSet("15","5,0","2",90,"1,5 min"),mkSet("12","5,0","1",90,"1,5 min"),mkSet("12","5,0","0 (Fallo),mkSet("12","5,0","0 (Fallo)] },
    { name:"Push-up Plus", sets:[mkSet("15","Peso corporal","2",90,"1,5 min"),mkSet("15","Peso corporal","1",90,"1,5 min"),mkSet("Fallo tecnico","Peso corporal","0",90,"1,5 min"),mkSet("Fallo tecnico","Peso corporal","0",90,"1,5 min")] }
  ]},
  "5": { id:"5", name:"Pierna B + Brazos B", fullName:"DIA 5: Pierna B y Brazos B", description:"Vector primario: asimetria, gluteos, lumbares, brazos y core", exercises:[
    ...
    { name:"Curl femoral sentado", sets:[mkSet("10","30,0","2",90,"1,5 min"),mkSet("9","35,0","1",90,"1,5 min"),mkSet("8","40,0","0 (Fallo),mkSet("15","60,0","1",90,"1,5 min"),mkSet("12","65,0","0 (Fallo),mkSet("12","65,0","0 (Fallo)] },
    { name:"Maquina cuadriceps unilateral", sets:[mkSet("15","20,0","2",90,"1,5 min"),mkSet("12","25,0","1",90,"1,5 min"),mkSet("10","30,0","0 (Fallo),mkSet("10","30,0","0 (Fallo)] },
    { name:"Abductores maquina", sets:[mkSet("15","50,0","2",90,"1,5 min"),mkSet("12","55,0","1",90,"1,5 min"),mkSet("12","60,0","0 (Fallo),mkSet("12","60,0","0 (Fallo)] },
    { name:"Elevacion de Gemelos (Prensa)", sets:[mkSet("15","70,0","2",90,"1,5 min"),mkSet("12","80,0","1",90,"1,5 min"),mkSet("10","90,0","0 (Fallo),mkSet("10","90,0","0 (Fallo)] },
    ...
    { name:"Mancuernas biceps", sets:[mkSet("15","10,0","2",90,"1,5 min"),mkSet("12","12,5","1",90,"1,5 min"),mkSet("10","12,5","0 (Fallo),mkSet("10","12,5","0 (Fallo)] },
    { name:"Triceps polea soga", sets:[mkSet("15","25,0","2",90,"1,5 min"),mkSet("12","30,0","1",90,"1,5 min"),mkSet("10","35,0","0 (Fallo),mkSet("10","35,0","0 (Fallo)] },
    { name:"Elevacion de rodillas colgado", sets:[mkSet("Fallo tecnico (~15),mkSet("Fallo tecnico (~12),mkSet("Fallo tecnico (~10),mkSet("Fallo tecnico (~10),mkSet("Fallo tecnico (~10)] },
    { name:"Elevaciones de Tibial", sets:[mkSet("20","Peso corporal","2",90,"1,5 min"),mkSet("15","Peso corporal","1",90,"1,5 min"),mkSet("Fallo tecnico","Peso corporal","0",90,"1,5 min"),mkSet("Fallo tecnico","Peso corporal","0",90,"1,5 min")] }
  ]}
};
