export const createRecipesView = ({
  ...
  ISync
      ...
      const loadSweetsStock = useCallback(async () => {
        ...
        try {
          ...
          if(error) {
            ...
            setSweetsMsg('Stock local cargado. El guardado remoto estÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ restringido por permisos.');
            return;
          }
      ...
      const persistSweetsPayload = async (payload, okMsg) => {
        ...
        if(error) {
          setSweetsMsg(`${okMsg} Guardado local porque el remoto estÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ restringido por permisos.`);
        } else {
          setSweetsMsg(okMsg);
        }
        setTimeout(() => setSweetsMsg(''), 2500);
      ...
      const saveSweetsStock = async () => {
        ...
        try {
          ...
          if(error) {
            setSweetsMsg('Stock guardado en este dispositivo. El guardado remoto estÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ restringido por permisos.');
          } else {
      ...
      const isCondimentLike = (recipe) => {
        ...
        return [
          'sal', 'pimienta', 'oregano', 'orÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©gano', 'aji', 'ajÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­', 'ajo', 'perejil',
          'mostaza', 'mayonesa', 'ketchup', 'chimichurri', 'salsa', 'vinagre',
          'aceite', 'aderezo', 'picante', 'paprika', 'comino', 'curcuma', 'cÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âºrcuma'
          ...
          >
            <div style="display:flex;flex-direction:column;gap:12px;">
              ...
              <div style="display:flex;flex-direction:column;gap:8px;">
                ...
                <p style="margin:0;font-size:11px;color:#94A3B8;">Si esta opcion esta apagada, el item sirve para macros y reconocimiento, pero no mueve stock. Ideal para cumpleaÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â±os, comidas afuera o cosas que no compras para tu casa.</p>
                <p style="margin:0;font-size:11px;color:#94A3B8;">AdemÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡s, el descuento automÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡tico de stock queda pensado para ingredientes simples como huevo, pollo, arvejas o lentejas. Las recetas compuestas no descuentan stock automÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡tico.</p>
                ...
                <p style="margin:0;font-size:11px;color:#94A3B8;">Ingredientes: ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âºtil si es una receta compuesta. Si es un ingrediente simple, lo podÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©s dejar vacÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­o.</p>
                  ...
                  <div style="margin-top:6px;padding:10px;border-radius:8px;background:rgba(8,13,26,0.45);border:1px solid #1E2D45;display:flex;flex-direction:column;gap:8px;">
                    ...
                    <div style="padding:8px 10px;border-radius:8px;background:rgba(15,23,41,0.7);border:1px solid rgba(56,189,248,0.18);">
                      ...
                      <p style="margin:4px 0 0;font-size:13px;color:#E2E8F0;font-weight:700;">
                        ${topSeller ? `${topSeller[0]} ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· ${topSeller[1]}` : 'Sin ventas en este rango'}
                      </p>
                    </div>
                            ...
                            <div style="display:flex;justify-content:space-between;gap:8px;align-items:flex-start;">
                              <div style="flex:1;">
                                ...
                                <p style="margin:0;font-size:12px;color:#E2E8F0;white-space:pre-wrap;">
                                  ${(entry.items || []).map(item => `${item.key}: ${item.qty}`).join(' ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· ') || 'Venta sin detalle'}
                                </p>
                              </div>
                              <div style="display:flex;flex-direction:column;gap:6px;">
